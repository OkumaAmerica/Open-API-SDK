...
namespace ScoutTestApplication 
{
    ...
    public partial class ScoutTestApplicationForm : Form
    {
        ...
        private void Button_SpecCodes_Click(object sender, EventArgs e)
        {
            ...
            this.TextBox_PLCSpec1A_Match.Text = Okuma.Scout.SpecCode.Match_PLC1_FirstHalf;
            this.TextBox_PLCSpec1B_Match.Text = Okuma.Scout.SpecCode.Match_PLC1_SecondHalf;
            this.TextBox_PLCSpec2A_Match.Text = Okuma.Scout.SpecCode.Match_PLC2_FirstHalf;
            this.TextBox_PLCSpec2B_Match.Text = Okuma.Scout.SpecCode.Match_PLC2_SecondHalf;
            this.TextBox_NCSpecA_Match.Text = Okuma.Scout.SpecCode.Match_NC1_FirstHalf;
            this.TextBox_NCSpecB_Match.Text = Okuma.Scout.SpecCode.Match_NC1_SecondHalf;
            this.TextBox_NCBSpecA_Match.Text = Okuma.Scout.SpecCode.Match_NCB1_FirstHalf;
            this.TextBox_NCBSpecB_Match.Text = Okuma.Scout.SpecCode.Match_NCB1_SecondHalf;
        }
