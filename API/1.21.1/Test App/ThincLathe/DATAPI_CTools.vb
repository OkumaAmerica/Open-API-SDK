...
#Region "Public Sub Routines for accessing Tool Data"
    ''' <summary>
    ...
    Public Sub ToolData()
        ...
        MsgBox("Finish calling ToolData()")
    End Sub
#End Region
...
#Region "CTools.ReferenceToolOffset Example"
    ...
    Private Sub ReferenceToolOffset_12(ByVal enSubSystem As Okuma.CLDATAPI.Enumerations.SubSystemEnum, _
        ...
        If IsP300L() Then
            ...
            enSpindleAxisMode = objTools.GetSpindleAxisMode(intToolNo, enToolEdge, enToolCuttingPosition)
...
#Region "Helper Functions"
    ...
    Private Function CheckMethodSpec(ByVal enMethodType As MethodTypeEnum, _
        ...
        Select Case enMethodType
            ...
            Case MethodTypeEnum.ToolGroup_P300S, _
                MethodTypeEnum.ToolGaugeStatus_P300S, _
...
#Region "CTools.RegisterTools Example"
    ...
    Public Function GetToolCuttingPositionNos() As Integer()
        ...
        intToolCuttingPositionNos = Array.CreateInstance(GetType(Integer), 20)
