...
Module modMain
    ...
    Sub Main()
        ...
        Try
            ...
            If objFile.Exists(m_strTHINCAPIPath + "\" + "Okuma.CLDATAPI.dll") Then
                CheckFileVersion(m_strTHINCAPIPath + "\" + "Okuma.CLDATAPI.dll", 1, 9, 0, 0)
            End If

            If objFile.Exists(m_strTHINCAPIPath + "\" + "Okuma.CLCMDAPI.dll") Then
                CheckFileVersion(m_strTHINCAPIPath + "\" + "Okuma.CLCMDAPI.dll", 1, 5, 0, 0)
            End If
