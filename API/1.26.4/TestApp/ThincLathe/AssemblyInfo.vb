...
<Assembly: AssemblyDescription("THINC Lathe Sample application")> 
<Assembly: AssemblyCompany("Okuma America Corporation")> 
<Assembly: AssemblyProduct("THINC Lathe Sample")>
<Assembly: AssemblyCopyright("Copyright ©  2025 Okuma America Corporation")>
...
<Assembly: AssemblyVersion("1.26.4.0")>
...
'<Assembly: AssemblyVersion("1.21.4.0")> 
''for BETA release 1.21.4.0
...
'correct set data unit P300TOOL-2: m_objTurret.SetDataUnit(Me.cboP300ToolsDataUnit2.SelectedValue)
'<Assembly: AssemblyVersion("1.22.1.1")> 
'add storetool with chip prep mode on

'<Assembly: AssemblyVersion("1.22.2.0")> 
'beta release 10/31/2019

'<Assembly: AssemblyVersion("1.23.0.0")> 
'Public Release 1.23.0.0 to OCJ

'<Assembly: AssemblyVersion("1.23.1.0")> 
'Public Release 1.23.1.0 

'<Assembly: AssemblyVersion("1.24.0.0")> 
'Public Release 1.24.0.0 

'<Assembly: AssemblyVersion("1.24.1.0")> 
'Public Release 1.24.1.0 


'<Assembly: AssemblyVersion("1.24.2.0")> 
'Public Release 1.24.2.0 

'<Assembly: AssemblyVersion("1.24.3.0")> 
'Public Release 1.24.3.0 

'<Assembly: AssemblyVersion("1.25.0.0")> 
'Public Release 1.25.0.0 


'<Assembly: AssemblyVersion("1.25.1.0")> 
'Public Release 1.25.1.0 
'<Assembly: AssemblyVersion("1.26.0.0")> 
'Public Release 1.26.0.0 
'<Assembly: AssemblyVersion("1.26.1.0")> 
'Public Release 1.26.1.0 
'<Assembly: AssemblyVersion("1.26.2.0")> 
'Public Release 1.26.2.0 
'<Assembly: AssemblyVersion("1.26.3.0")> 
'Public Release 1.26.3.0 
'<Assembly: AssemblyVersion("1.26.4.0")> 
'Public Release 1.26.4.0 
